...
function Home() {
    return (
        <div className="animate-[fadeIn_0.7s_ease-out]">
            ...
            <section id="terms" className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
                <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
                    ...
                    <a
                        href="/enrollment"
                        className="mt-6 inline-flex items-center justify-center rounded-full bg-blue-600 px-6 py-3 text-sm font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-blue-700"
                    >
                        Review Terms
                    </a>
                </div>
            ...
            <section id="contact" className="mx-auto max-w-7xl px-4 pb-10 sm:px-6 lg:px-8 lg:pb-16">
